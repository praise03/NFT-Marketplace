...
export interface TestNftInterface extends utils.Interface {
  functions: {
    ...
    "getCurrentCount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getCurrentCount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TestNft extends BaseContract {
  ...
  getCurrentCount(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    NftMinted(tokenId?: null, owner?: null): NftMintedEventFilter;
  ...
  populateTransaction: {
    ...
    getCurrentCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
